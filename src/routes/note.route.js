...
import { redisAllAuth, redisSingleAuth } from '../middlewares/RedisMdlw';
...
router.get('', userAuth, redisAllAuth, noteController.getAll);

// routes to get a note by id
router.get('/:_id', userAuth, redisSingleAuth, noteController.getById);
